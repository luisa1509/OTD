...
.attr('class', 'd3-tip')
.html(d => {
  let text = `<strong>Caracterización:</strong> <span style='color:#CC3454;text-transform:capitalize'>${d.caracter}</span><br>`
...
g.append("text")
  ...
  .attr("fill","#2A2A2F")
  .text("Caracterización de Producto")
...
d3.csv("../data/caracterizacion.csv").then(data => {
  data.forEach(d => {
